...
const imgAprovado = '<img src="imagens/feliz.png" alt="Emoji festejando">';
const imgReprovado = '<img src="imagens/triste2.png" alt="Emoji triste">';
const atividades = [];
const notas = [];
...
function adicionaLinha(){
    ...
    if(atividades.includes(inputNomeAtividade.value)){
        alert(`A atividade:  ${inputNomeAtividade.value} foi inserida!`);
    } 
